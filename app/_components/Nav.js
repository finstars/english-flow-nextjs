    ...
    return (
        <div className={`${styles.nav} nav`}>
            <div className={styles.navLinks}>
                ...
                <Link onClick={handleClick} className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>Video Lessons</span> 1-Week Course</Link>

                <Link onClick={handleClick} className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>Self-Paced</span> English Practice</Link>
                ...
                <Link onClick={handleClick} className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>About us</span> Team & Mission</Link>
