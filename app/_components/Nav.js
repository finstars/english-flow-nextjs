    ...
    return (
        <div className={`${styles.nav} nav`}>
            <div className={styles.navLinks}>
                ...
                <Link onClick={handleClick} className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>Beginner</span> 1-Week Course</Link>

                <Link onClick={handleClick} className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>Practice</span> Spoken English</Link>
