    ...
    return (
        <div className={`${styles.nav} nav`}>
            <div className={styles.navLinks}>
                ...
                <Link className={pathname.includes("/shadowing-technique-english-lessons") ? styles.active : ""} href="/shadowing-technique-english-lessons"><span>Lvl 1. Beginner</span> Shadowing</Link>
                <Link className={pathname.includes("/conversational-english-lessons") ? styles.active : ""} href="/conversational-english-lessons"><span>Lvl 2. Intermediate</span> Conversational</Link>
                <Link className={pathname.includes("/tpr-storytelling-english-lessons") ? styles.active : ""} href="/tpr-storytelling-english-lessons"><span>Lvl 3. Advanced</span> TPR Storytelling</Link>

                <Link href="https://shop.englishflow.ai">
                    Shop
