...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Conversational English: ${title} - Step ${card}`,
    description: `Practice Conversational English using our "${title}" English lesson.`
  }
}
...
export default async function Home({ params }) {
  ...
  return (
    <main id="lesson" className={styles.main}>
      <Link className={styles.goBack} href="/conversational-english-lessons">
